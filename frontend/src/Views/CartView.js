...
export const CartLogic = () => {
    ...
    switch (fieldName) {
      ...
      case "cardNumber":
        if (!/^(\d{4}-){3}\d{4}$/.test(value)) {
          newErrors.cardNumber = "Please enter 0-9 digits only.";
        } else {
  ...
  return (
    ...
    <div className="bg-gray-400 pt-16">
      <div
        className="bg-purple-500  lg:block  h-flex w-1/2 fixed hidden left-0 top-0"
        aria-hidden="true"
      />
      <div
        className="bg-gray-400 fixed right-0  h-flex  w-1/2 top-0 hidden lg:block"
        aria-hidden="true"
      />
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            <div className="mb-4 flex justify-between items-end">
              ...
              <button
                ...
                type="button"
                className="text-sm font-black px-3.5 rounded-md hover:bg-purple-600 flex py-2.5 gap-x-4 bg-black text-white shadow-sm">
                ← Back to Shop
              </button>
            </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <div className="border-black sm:justify-between mt-10 pt-6 border-t sm:flex sm:items-center">
              <button
                ...
                // submit order button
                className="border px-4 py-2 rounded-md w-full text-black bg-purple-600 font-black text-sm shadow-sm hover:bg-green-400 sm:w-auto border-transparent sm:order-last">
                Submit Order
              </button>
            </div>
          </div>
